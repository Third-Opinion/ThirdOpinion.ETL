CREATE MATERIALIZED VIEW rpt_fhir_observations_total_bilirubin_hmu_v1
DISTSTYLE KEY
DISTKEY (patient_id)
...
WHERE tp.observation_category = 'laboratory'
    ...
    AND (
        tp.observation_text ILIKE '%bilirubin%total%'
        OR tp.observation_text ILIKE '%total%bilirubin%'
    )
