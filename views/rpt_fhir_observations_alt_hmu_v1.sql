CREATE MATERIALIZED VIEW rpt_fhir_observations_alt_hmu_v1
DISTSTYLE KEY
DISTKEY (patient_id)
...
WHERE tp.observation_category = 'laboratory'
    ...
    AND (
        tp.observation_text ILIKE '%ALT%'
        OR tp.observation_text ILIKE '%alanine%aminotransferase%'
        OR tp.observation_text ILIKE '%SGPT%'
    )
