CREATE MATERIALIZED VIEW rpt_fhir_observations_hemoglobin_hmu_v1
DISTSTYLE KEY
DISTKEY (patient_id)
...
WHERE tp.observation_category = 'laboratory'
    ...
    AND (
        tp.observation_text ILIKE '%hemoglobin%'
        OR tp.observation_text ILIKE '%HGB%'
        OR tp.observation_text ILIKE '%HB%'
    )
