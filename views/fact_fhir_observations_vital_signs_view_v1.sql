-- ===================================================================
-- FACT FHIR OBSERVATIONS VIEW V1 (VITAL SIGNS ONLY)
--
-- OVERVIEW:
...
-- - public.observation_codes: Observation codes from different coding systems
...
CREATE MATERIALIZED VIEW fact_fhir_observations_vital_signs_view_v1
AS
...
-- USAGE NOTES
-- This view provides a comprehensive vital signs observations dataset with:
...
-- 5. Components for multi-part observations (e.g., blood pressure)
-- 6. Categories and interpretations
--
-- The view includes ONLY vital signs observations (heart rate, blood pressure,
-- temperature, respiratory rate, oxygen saturation, height, weight, BMI, etc.)
