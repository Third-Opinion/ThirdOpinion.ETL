# Deployed: 2025-10-09 06:27:56 UTC
...
def main():
    ...
    try:
        ...
        table_names = ["encounter_hospitalization", "encounter_locations", "encounter_participants", "encounter_reasons", "encounter_types", "encounters"]
