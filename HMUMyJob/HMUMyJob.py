# Deployed: 2025-10-09 04:25:42 UTC
...
def write_to_redshift_versioned(dynamic_frame, table_name, resource_id, preactions=""):
...
def main():
    ...
    try:
        ...
        write_to_redshift_versioned(main_resolved_frame, "conditions", "resource_id", conditions_table_sql)
        ...
        write_to_redshift_versioned(categories_resolved_frame, "condition_categories", "resource_id", categories_table_sql)
        ...
        write_to_redshift_versioned(notes_resolved_frame, "condition_notes", "resource_id", notes_table_sql)
        ...
        write_to_redshift_versioned(body_sites_resolved_frame, "condition_body_sites", "resource_id", body_sites_table_sql)
        ...
        write_to_redshift_versioned(stages_resolved_frame, "condition_stages", "resource_id", stages_table_sql)
        ...
        write_to_redshift_versioned(codes_resolved_frame, "condition_codes", "resource_id", codes_table_sql)
        ...
        write_to_redshift_versioned(evidence_resolved_frame, "condition_evidence", "resource_id", evidence_table_sql)
        ...
        write_to_redshift_versioned(extensions_resolved_frame, "condition_extensions", "resource_id", extensions_table_sql)
